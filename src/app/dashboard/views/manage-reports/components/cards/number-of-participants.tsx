...
import { UsersAttemptedVsUsersUnAttempted } from "@/lib/types/reportTypes";

interface NumberOfParticipantsProps {
  props: UsersAttemptedVsUsersUnAttempted;
}

const NumberOfParticipants: React.FC<NumberOfParticipantsProps> = ({
  props,
}) => {
  const chartData = [
      ...
      <Card className="flex flex-col">
        <CardHeader className="items-center pb-0">
          <CardTitle className="text-[10px]">
            Users Attempted vs Users Not Attempted
          </CardTitle>
        </CardHeader>
