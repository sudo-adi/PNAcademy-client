...
const ViewGroupDialog: React.FC<ViewUsersDialogProps> = ({ group }) => {
  ...
  // global states
  const { sortBy, order, setOrder, setSortBy } =
                ...
                <Table>
                  ...
                  <TableBody>
                    {users.map((user: SingleUser) => (
                      <Row key={user.id} user={user} loading={loadingUsers} />
                    ))}
                  </TableBody>
                </Table>
              ) : (
          ...
          <button
            onClick={() => {
              ...
              toast({
                ...
                action: <ToastAction altText="Email Copied">ok</ToastAction>,
              });
            }}
          >
          ...
          <button
            onClick={() => {
              ...
              toast({
                ...
                action: (
                  <ToastAction altText="Phone Number Copied">ok</ToastAction>
                ),
              });
            }}
          >
